(function($) {
  ...
  const eventDay = new Date("Thu Nov 10 2022 20:00:00 GMT+0800 (CST)");
  const today = new Date();
  let youtubeLink = ""

  if (eventDay <= today) {
    $(".float-nav__btn-yt").css("background-image", "url(" + "../images/float-btn-yt-2@2x.png" + ")");
    youtubeLink = "https://www.youtube.com/channel/UCXelBqmb9mvGre1EzRwAQdg";
  } else {
    youtubeLink = "https://www.youtube.com/channel/UCXelBqmb9mvGre1EzRwAQdg";
  }

  $(".float-nav__btn-yt a").attr("href", youtubeLink);
